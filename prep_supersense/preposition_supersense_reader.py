...
@DatasetReader.register("preposition_supersense")
class SupersenseReader(DatasetReader):
  '''
  ...
  def _read(self, file_path: str):
    ...
    for (sentence, predicate_location, supersense1, supersense2, tags, filename) in srl_data:
      ...
      prep_indicator = [1 if "B-PREP" in tag else 0 for tag in tags]
  ...
  def text_to_instance(self, tokens: List[Token], prep_label: List[int], supersense1: str=None, supersense2: str=None, tags: List[str]=None, filename: str=None) -> Instance:
    '''
    ...
    if supersense1 is not None:
      supersense1_label = LabelField(supersense1)
      fields["supersense1_labels"] = supersense1_label
      metadata_dict["gold_supersense1"] = supersense1

    if supersense2 is not None:
      supersense2_label = LabelField(supersense2)
      fields["supersense2_labels"] = supersense2_label
      metadata_dict["gold_supersense2"] = supersense2
