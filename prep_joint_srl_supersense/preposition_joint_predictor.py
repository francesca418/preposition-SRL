...
@Predictor.register("preposition_joint")
class PrepositionJointPredictor(Predictor):
  '''
  ...
  def predict(self, sentence: str) -> JsonDict:
    ...
    {"words": [...],
     "prepositions": [
       {"prepositions": "...", "description": "...", "supersense1": "...", "supersense2": "...", "tags": [...]},
       ...
       {"prepositions": "...", "description": "...", "supersense1": "...", "supersense2": "...", "tags": [...]},
     ]}
    ```
  ...
  def predict_batch_json(self, inputs: List[JsonDict]) -> List[JsonDict]:
    ...
    for sentence_index, prep_count in enumerate(preps_per_sentence):
      ...
      for _ in range(prep_count):
        ...
        return_dicts[sentence_index]["prepositions"].append({"preposition": output["preposition"], "predicate_index": output["preposition_indices"], "description": description, "tags":tags, "supersense1": supersense1, "supersense2": supersense2})
        output_index += 1
  ...
  def predict_instances(self, instances: List[Instance]) -> JsonDict:
    ...
    for output in outputs:
      ...
      results["prepositions"].append({"preposition": output["preposition"], "predicate_index": output["preposition_indices"], "description": description, "tags": tags, "supersense1": supersense1, "supersense2": supersense2})
