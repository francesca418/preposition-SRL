...
@Predictor.register("preposition_role")
class PrepositionSupersensePredictor(Predictor):
  ...
  def predict_instances(self, instances: List[Instance]) -> JsonDict:
    ...
    for output in outputs:
      ...
      results["prepositions"].append({"preposition": output["preposition"], "predicate_index": output["preposition_indices"], "role": supersense1})
