...
@Predictor.register("preposition_function")
class PrepositionSupersensePredictor(Predictor):
  ...
  def predict_batch_json(self, inputs: List[JsonDict]) -> List[JsonDict]:
    ...
    for sentence_index, prep_count in enumerate(preps_per_sentence):
      ...
      for _ in range(prep_count):
        ...
        return_dicts[sentence_index]["prepositions"].append({"preposition": output["preposition"], "predicate_index": output["preposition_indices"], "function": supersense2})
        output_index += 1
  ...
  def predict_instances(self, instances: List[Instance]) -> JsonDict:
    ...
    for output in outputs:
      ...
      results["prepositions"].append({"preposition": output["preposition"], "predicate_index": output["preposition_indices"], "function": supersense2})
